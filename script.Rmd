...
Estos resultados provenen sobretodo de aquellas mujeres que han seguido casadas despues de la reforma. (La autora sugiere que puede ser que al principio los hombres tengamos herramientas no violentas para disuadir pero en el largo plazo estas son insuficientes)
...
La muestra es compuesta por mujeres casadas durante la reforma y continúan casadas o estaban divorciadas durante la encuesta.

Se excluyeron aquellas que se casaron después de la reforma.
...
- 2003: 23,333 (100% continuaron casadas)
- 2006: 66,157 (% continuaron casadas)
- 2011: 74,770 (% continuaron casadas)
- 2016: 50,712 (% continuaron casadas)
]
...
•	29 preguntas comparables en las distintos años que se llevó la encuesta, no obstante, se eleimino la pregunta sobre si la pareja le dejó de hablar.

.pull-left[
Las 28 preguntas están divididas en 4 grupos de IPV:
1. Física .right[[1,0]]
2. Sexual .right[[1,0]]
3. Emocional .right[[1,0]]
4. Económica .right[[1,0]]
5. Plus: Cualquiera .right[[1,0]]
...
Controles
.pull-left[
1era especificación (empatar nombre):
-	Edad de la mujer
...
--
####Impacto de los divoricios(mejorar titulo)
.left[Para análisis del divorcio unilateral en la tasa de divorcio se utilizaron las variables:] 
...
```
---
##  Efectos en matrimonios y divorcios 

<img style="float: right;" src="img/TablaB2.jpg" width="340" height="500">

<div style="text-align: justify">

* Aumento en la tasa de divorcio en 34% respecto a antes de la reforma
* Incremento de 38% en número de divorcios por cada 1000 personas casadas 
* No hay evidencia de impacto en el número de matrimonios por cada 1000 personas 

---
##  Efectos en matrimonios y divorcios: MPL

<img style="float: right;" src="img/Tabla2.jpg" width="340" height="500">
...
<img style="float: right;" src="img/TablaC3.jpg" width="340" height="500">
...
# *diagrama: easier divorce -> IPV -> afecta a matrimonios que se disuelven o no-> matrimonios que se disuelven
...
La autora estima si la reforma tuvo un impacto en alguna de estas variables, obtiene coeficientes no significativos en el corto y largo plazo. Concluye que este segundo mecanismo no se observa en los datos.

---
### Mecanismos: VP como instrumento de control

<img style="float: right;" src="img/Tabla8.jpg" width="340" height="500">
