...
<img style="float: right;" src="img/TablaB171.jpg" width="720" height="420">
...
Algunas limitaciones/comentarios adicionales podrían ser: 

*  hhh

* Contemplar el cambio de la compensación económica que trajo consigo la reforma como mecanismo de causalidad de la violencia 

* Relación mixta del nivel de educación con las posibilidades de salida, debido a posibles variables omitidas
